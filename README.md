...
Respuesta: A la hora de correr el proyecto se ve mucho más profesional y limpio visualmente.
### HTML:
...
Respuesta: Se adapta a cualquier dispositivo donde se esté visualizando,se vuelve una página responsiva y le da un toque de profesionalismo.
...
Respuesta: Agregué una transición a la sección de películas y gustos para que cuando se deslice el mouse haya un desplazamiento sutil.
